...
namespace Elitist_Ant_System
{
    class EAS
    {
        ...
        public static double NearestNeighbour(Graph g)
        {
        ...
        // Implementacja pseudolosowego wyboru
        public static int RouleteWheel(double[] tNode, int Ncitys, List<int> list)
        {
            double sum = 0;
            Random rnd = new Random();
        ...
        public static void GenerateSolution(Graph g, Colony[] a, int antNo)
        {
            int nodeNo = g.len;
        ...
        public static double CalculateCostOfPath(Graph g, Colony ant)
        {
            double distance = 0;
        ...
        public static void TakeBestResult(Graph g, Colony[] m, int nAnts)
        {
        ...
        public static void UpdatePheromone(Graph g, Colony[] m, int nAnts, double e)
        {
            for (int i = 0; i < nAnts; i++)
            {
        ...
        public static void Evaporation(Graph g)
        {
            for (int i = 0; i < g.len; i++)
            {
