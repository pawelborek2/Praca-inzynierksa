...
namespace Ant_Colony_01
{
    class Program
    {
        ...
        class Graph
        {
            ...
            public double evaporation = 0.5; // parowanie
        ...
        static void GenerateSolution(Graph g, Colony[] a,int antNo)
        {
            ...
            for (int i=0;i<antNo;i++) // przechodzimy po wszystkich mrowkach
            {
                ...
                for (int j=1;j<nodeNo;j++) // kolejne wybory mrowki
                {
                    ...
                    double [] pAllNodes = new double[nodeNo]; //lista prawdopodobienstw
        ...
        static void Main(string[] args)
        {
            ...
            double T0; 
            T0 = nAnts / (g.len*iVal); // poczatkowe wartosci feromonow
            ...
            for (int t=0;t<maxinter;t++) // Główna pętla dla algorytmu
            {
                ...
                UpdatePheromone(g,m,nAnts); // Zaktualizowanie sladow feromonowych
